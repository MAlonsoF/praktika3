...
class GrafoaSortuTest {
    ...
    void setUp() {
        ...
        biltegi.erreseteatu(); // limpiar singleton antes de cada test
        grafoa = new Graph();
    }
    ...
    void elkarlanAnitzEtaKonplexuak() {
        ...
        e1.gehituArgitalpena(a1);
        e1.gehituArgitalpena(a3);

        e2.gehituArgitalpena(a1);
        e2.gehituArgitalpena(a2);

        e3.gehituArgitalpena(a2);
        e3.gehituArgitalpena(a3);

        biltegi.gehituEditorea(e1);
        biltegi.gehituEditorea(e2);
        biltegi.gehituEditorea(e3);
        ...
        // Editore bakoitza beste biekin konektatuta
        assertTrue(grafoa.adjList[idx1].contains(idx2));
